    ...
    <article className="LatestBook grid" style={{ borderColor: color }}>
      ...
      <div className="LatestBook__book flex-column">
        <div className="LatestBook__info">
          ...
          <h4 className="LatestBook__info--author mb-4">{author}</h4>
        ...
        <div>
          ...
          <div className="LatestBook__buttons flex">
            <button
              className="uppercase see-book"
              style={{ borderColor: color, backgroundColor: color }}
            >
              <Link to={seeBook}>See book</Link>
            </button>
            <button className="shopping-basket">
              <img src={shopingBaket} alt="" />
            </button>
